...
class Plotter:
    ...
    def __init__(self, company_name: str):
        ...
        self.__company_handler = data_fix.CsvHandler(company_name)
        ...
        self.__gpr = data_sum.Wrapper(company_name)
    ...
    def show_gp_prediction(self, train_start: int, train_end: int, pred_year: int, pred_quarters: list = None):
        ...
        fname = '{}_{}_{}_prediction.png'.format(self.__company_name, train_end, pred_year)
        fig.savefig(fname, dpi=fig.dpi)
        plt.clf()
